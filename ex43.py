...
class scene(object):
    def enter(self):
        print('Scene is not yet configured')
        print('Other classes(subclasses) inherits from scene class, check them out')
        exit(1)
...
class thebridge(scene):
    def enter(self):
        ...
        elif action == 'slowlyplacethebomb':
            print(dedent("""
